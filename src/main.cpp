...
private:
    ...
    void initWindow()
    {
        ...
        window_ = glfwCreateWindow(kWindowWidth, kWindowHeight, "Vulkan", nullptr, nullptr);
        if (window_ == nullptr)
        {
    ...
    void cleanup()
    {
        if (static_cast<vk::Device>(device_))
        {
            device_.waitIdle();
        }
    ...
    bool isDeviceSuitable(vk::raii::PhysicalDevice const& physicalDevice)
    {
        ...
        const bool supportsGraphics = std::ranges::any_of(
            queueFamilies,
        ...
        return supportsVulkan13 && supportsGraphics && supportsRequiredFeatures && supportsAllRequiredExtensions;
    }
    ...
    void createLogicalDevice()
    {
        ...
        {
            const bool supportsGraphics = !!(queueFamilyProperties[queueFamilyIndex].queueFlags & vk::QueueFlagBits::eGraphics);
            const bool supportsPresent = physicalDevice_.getSurfaceSupportKHR(queueFamilyIndex, *surface_);
        ...
        vk::DeviceCreateInfo deviceCreateInfo{
            ...
            .enabledExtensionCount = static_cast<std::uint32_t>(requiredDeviceExtensions_.size()),
    ...
    void createGraphicsPipeline()
    {
        ...
        vk::raii::ShaderModule vertexShaderModule(device_, vertexShaderCreateInfo);
        vk::raii::ShaderModule fragmentShaderModule(device_, fragmentShaderCreateInfo);
        ...
        pipelineLayout_ = vk::raii::PipelineLayout(device_, vk::PipelineLayoutCreateInfo{});
        ...
        graphicsPipeline_ = vk::raii::Pipeline(device_, nullptr, pipelineCreateInfo);
    }
    ...
    void createCommandBuffers()
    {
        ...
        commandBuffers_ = vk::raii::CommandBuffers(device_, allocateInfo);
    }

    void createSyncObjects()
    {
        imageAvailableSemaphore_ = vk::raii::Semaphore(device_, vk::SemaphoreCreateInfo{});
    ...
    void drawFrame()
    {
        (void)device_.waitForFences({*inFlightFence_}, true, std::numeric_limits<std::uint64_t>::max());
        ...
        queue_.submit({submitInfo}, *inFlightFence_);
    ...
    void recordCommandBuffer(vk::raii::CommandBuffer const& commandBuffer, std::uint32_t imageIndex)
    {
        ...
        vk::ClearValue clearValue{
            .color = vk::ClearColorValue(std::array<float, 4>{0.05f, 0.07f, 0.10f, 1.0f}),
        };
    ...
    static VKAPI_ATTR vk::Bool32 VKAPI_CALL debugCallback(
        ...
        vk::DebugUtilsMessengerCallbackDataEXT const* callbackData,
        void*
    )
    {
